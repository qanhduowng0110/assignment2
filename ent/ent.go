...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			apirequestlog.Table:   apirequestlog.ValidColumn,
			associatedevent.Table: associatedevent.ValidColumn,
			earthquake.Table:      earthquake.ValidColumn,
			earthquake_db.Table:   earthquake_db.ValidColumn,
			eventtype.Table:       eventtype.ValidColumn,
			featuretype.Table:     featuretype.ValidColumn,
			feltreport.Table:      feltreport.ValidColumn,
