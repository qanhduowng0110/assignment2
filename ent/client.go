...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.Apireq, c.Earthquake, c.FeatureType, c.FtypeEarthquake, c.Geometry,
		c.Location, c.Report, c.SchemaMigration, c.SourceEarthquake,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		Apireq, Earthquake, FeatureType, FtypeEarthquake, Geometry, Location, Report,
		SchemaMigration, SourceEarthquake []ent.Hook
	}
	inters struct {
		Apireq, Earthquake, FeatureType, FtypeEarthquake, Geometry, Location, Report,
		SchemaMigration, SourceEarthquake []ent.Interceptor
	}
)
